...
class FleafletVector extends StatefulWidget {
  FleafletVector({super.key});

  late _FleafletVector _fleaFlet;

  @override
  State createState() {
    _fleaFlet = _FleafletVector();
    return _fleaFlet;
  }
...
class _FleafletVector extends State<FleafletVector> {
  /*
  var layers = [
    TileLayer(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: FlutterMap(
        options: MapOptions(
          center: LatLng(36.96758, 127.0161),
          zoom: 14,
          maxZoom: 17,
        ...
        nonRotatedChildren: [
          AttributionWidget.defaultWidget(
            source: 'Stadia Maps © OpenMapTiles',
            onSourceTapped: () {
            },
          )
        ],
        children: [
          VectorTileLayer(
            tileProviders: TileProviders(
              {
                'openmaptiles': _cachingTileProvider(urlTemplate),
              },
            ),
            theme: ThemeReader().read(myTheme),
          ),
        ],
      ),
    );
  ...
  var urlTemplate = 'http://192.168.110.3:8080/data/v3/{z}/{x}/{y}.pbf';
